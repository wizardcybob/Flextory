<x-app-layout>
    ...
    <div class="w-full mx-auto flex flex-col gap-8">
        <button class="btn_primary w-fit" onclick="window.history.back()" role="button" aria-label="Retour à la page précédente" title="Retour à la page précédente"><i class="fa-solid fa-chevron-left" aria-hidden="true"></i>
            Retour</button>
        <h1 class="titre_page">Création d'un enseignant</h1>
        ...
        <form action="{{ route('teacher.store') }}" method="POST" class="flex flex-col gap-4">
            ...
            <div class="relative w-full mt-4">
                ...
                <select class="select_form" id="department" name="department" aria-labelledby="department-label" required aria-required="true">
            ...
            <div class="relative w-full mt-4">
                ...
                <select class="select_form" id="status" name="status" aria-labelledby="status-label" required aria-required="true">
