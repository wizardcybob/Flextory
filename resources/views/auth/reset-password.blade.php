    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="block">
                ...
                <x-jet-input aria-labelledby="Email" id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <x-jet-button aria-labelledby="Réinitialiser le mot de passe">
                    {{ __('Reset Password') }}
                </x-jet-button>
            </div>
        </form>
